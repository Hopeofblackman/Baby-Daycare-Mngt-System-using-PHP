            ...
            <div class="wthree-info-para">
               ...
               <form method="post">
                  ...
                  <div class="contact-mid row">
                   ...
                   <div class="contact-mid row">
                     <div class="col-lg-6 col-md-6 col-sm-6 form-group contact-forms"><label>Business name:</label>
                        <input type="text" class="form-control" placeholder="Child Name" required="" name="childname">
                     </div>
                     <div class="col-lg-6 col-md-6 col-sm-6 form-group contact-forms"><label>Company years:</label>
                        <input type="date" class="form-control" placeholder="Date of Birth" required="" name="dob">
                     </div>
                  </div>
                  <div class="contact-mid row">
                     <div class="col-lg-6 col-md-6 col-sm-6 form-group contact-forms"><label>company status:</label>
