...
<html lang="zxx">
   <head>
      <title>Iteru Web Application | Info of Babysitter</title>
      <!--meta tags -->
   ...
   <body>
      ...
      <section class="blog py-lg-4 py-md-3 py-sm-3 py-3" id="blog">
         <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Our Web Developers</h3>
            <div class="row">
              <?php
...
?>
               <div class="col-lg-6 col-md-6 blog-by-blog border-grid-bottom">
                  <div class="row">
                     ...
                     <div class="col-lg-4">
                        <img src="admin/images/<?php  echo $row['ProfilePic'];?>" class="img-fluid" alt="">
                     </div>
